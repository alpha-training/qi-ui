...
let _stacks: Record<string, Stack> = {
  Dev1: {
    ...
    base_port: 8000,
    processes: {
      binance1: { pkg: 'binance', port_offset: 100, publish_to: ['tp1'] },
      massive1: { pkg: 'massive', port_offset: 101, publish_to: ['tp1'] },
      alpaca1:  { pkg: 'alpaca',  port_offset: 102, publish_to: ['tp1'] },
      kraken1:  { pkg: 'kraken',  port_offset: 103, publish_to: ['tp1'] },
      tp1:      { pkg: 'tp',      port_offset: 10,  publish_to: ['rdb1', 'wdb1'] },
      rdb1:     { pkg: 'rdb',     port_offset: 11,  subscribe_to: { tp1: '*' } },
      wdb1:     { pkg: 'wdb',     port_offset: 12,  subscribe_to: { tp1: '*' }, hdb: 'hdb1' },
  ...
  Dev2: {
    ...
    base_port: 9000,
    processes: {
      alpaca1: { pkg: 'alpaca', port_offset: 0, publish_to: ['tp1'] },
      tp1:     { pkg: 'tp',     port_offset: 10, publish_to: ['rdb1'] },
      rdb1:    { pkg: 'rdb',    port_offset: 11, subscribe_to: { tp1: '*' } },
    },
  },
  Prod: {
    ...
    base_port: 7000,
    processes: {
      binance1: { pkg: 'binance', port_offset: 0,  publish_to: ['tp1'] },
      tp1:      { pkg: 'tp',      port_offset: 10, publish_to: ['rdb1', 'wdb1'] },
      rdb1:     { pkg: 'rdb',     port_offset: 11, subscribe_to: { tp1: '*' } },
      wdb1:     { pkg: 'wdb',     port_offset: 12, subscribe_to: { tp1: '*' } },
      hdb1:     { pkg: 'hdb',     port_offset: 13 },
    },
  },
  Research: {
    ...
    processes: {
      ...
      massive1:{ pkg: 'massive', port_offset: 1, publish_to: ['tp1'] },
    },
  },
}
